#
#  Be sure to run `pod spec lint ZHJKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Kevin Zeng"
  # s.authors            = { "Kevin Zeng" => "503132987@qq.com" }
  ...
  s.source_files  = "ZHJKit/**/*.{h,m}"
  # s.exclude_files = "Classes/Exclude"

  s.public_header_files = "ZHJKit/**/*.{h}"
